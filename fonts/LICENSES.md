...
All fonts bundled with **physiologie · reskin** are free/open-source and are
redistributed here under their original licenses. Each family is listed with
its copyright and license below. The full text of the SIL Open Font License,
Version 1.1 follows the attributions.

## Families & attributions

| Family | Copyright | License |
|---|---|---|
| EB Garamond | © Georg Duffner, Octavio Pardo | SIL OFL 1.1 |
| Source Serif 4 | © Adobe (Frank Grießhammer) | SIL OFL 1.1 |
| Newsreader | © Production Type | SIL OFL 1.1 |
| Inter | © The Inter Project Authors (rsms) | SIL OFL 1.1 |
| Source Sans 3 | © Adobe | SIL OFL 1.1 |
| IBM Plex Sans | © IBM Corp. | SIL OFL 1.1 |
| IBM Plex Mono | © IBM Corp. | SIL OFL 1.1 |
| Space Mono | © Google (Colophon Foundry) | SIL OFL 1.1 |
| CMU Serif (Computer Modern) | © Andrey V. Panov, derived from Knuth's Computer Modern | SIL OFL 1.1 |
| CMU Typewriter Text | © Andrey V. Panov, derived from Knuth's Computer Modern | SIL OFL 1.1 |

woff2 subsets sourced via Fontsource (fontsource.org) and the
...
Copyright of each font remains with its authors as listed above.
